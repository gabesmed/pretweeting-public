...
function show_word_list(subpath, page) {
    if(subpath == 'delta') { title = "words by change"; }
    else if(subpath == 'change') { title = 'words by % change'; }
    else if(subpath == 'alpha') { title = 'words alphabetical'; }
    else { title = 'words' }
    show_discovery_content("/words/" + subpath + "/" + page, "list_link");
    return false;
}
...
function show_words() {
    show_discovery_content("/words/", "list_link");
    return false;
}

function show_help() {
    show_discovery_content("/info/help", "help_link");
    return false;
}

function show_portfolio() {
    show_discovery_content("/user/portfolio", "portfolio_link");
    return false;
}

function show_intro() {
    show_discovery_content("/user/intro", "intro_link");
    return false;
}

function show_chat() {
    show_discovery_content("/user/chat", "chat_link");
    return false;
}

function show_leaderboard() {
    show_discovery_content("/stats/leaderboard", "leaders_link");
    return false;
}

function show_trends() {
    show_discovery_content("/stats/trends", "trends_link");
    return false;
}
